...
func TestIndicesNames(t *testing.T) {
	...
	expectedIndicesNames := []string{"index0", "index1", "index2", "index3", "index4"}
...
func TestAliasedIndicesNames(t *testing.T) {
	aliasesInfo := []esclient.Alias{
		{Name: "index0", Index: "index0_123"},
		{Name: "index1", Index: "index1_123"},
		{Name: "index2", Index: "index2_123"},
		{Name: "index3", Index: "index3_123"},
		{Name: "index4", Index: "index4_123"},
	}
	...
	expectedAliasedIndices := []string{"index0_123", "index1_123", "index2_123", "index3_123", "index4_123"}
